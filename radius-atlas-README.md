...
A dependency-free, static web application prepared for GitHub and Vercel. It runs
...
> fixture. The production Vercel build imports Germany and France from GeoNames.
> Live archive downloads and an actual Vercel deployment were not verified in the
